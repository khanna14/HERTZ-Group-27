              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "a"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "b"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "c"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "d"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "e"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "f"),
                    HotPlayListCard(image: Random().nextInt(7) + 1, tag: "g")
                  ],
                ),
                Text(
                  "Our Choises for you",
